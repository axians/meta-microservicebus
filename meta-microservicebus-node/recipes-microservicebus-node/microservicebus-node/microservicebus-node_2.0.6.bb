...
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-core-util-is = "MIT"
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-inherits = "ISC"
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-isarray = "MIT"
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-process-nextick-args = "MIT"
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-safe-buffer = "MIT"
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-string-decoder-safe-buffer = "MIT"
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-string-decoder = "MIT"
LICENSE_${PN}-package-json-got-read-all-stream-readable-stream-util-deprecate = "MIT"
...
LICENSE_${PN}-tar-minizlib-minipass-safe-buffer = "MIT"
LICENSE_${PN}-tar-minizlib-minipass-yallist = "ISC"
